def run_functions(proteins, species):
	...
	known_interactions['Original geneID_A'] = IDs_df.loc[known_interactions['stringId_A'].values, 'queryItem'].values
	known_interactions['Original geneID_B'] = IDs_df.loc[known_interactions['stringId_B'].values, 'queryItem'].values
