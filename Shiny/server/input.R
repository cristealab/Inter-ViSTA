...
output$nodescontents <- DT::renderDataTable(user_input$nodes, options = list(pageLength = 5, 
                                                                         scrollX = TRUE))
...
output$edgescontents <- DT::renderDataTable(user_input$edges, options = list(pageLength = 5,
                                                                         scrollX = TRUE))
...
output$bgcontents <- DT::renderDataTable(user_input$background, options = list(pageLength = 5,
                                                                                 scrollX = TRUE))
...
output$proteomecontents <- DT::renderDataTable(head(user_input$proteome_abundance),
...
output$GOTablecontents <- DT::renderDataTable(head(user_input$GOTable),
                                           options = list(pageLength = 5, scrollX = TRUE))
